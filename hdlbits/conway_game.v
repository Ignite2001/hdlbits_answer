    ...
    generate
        ...
        for (i = 0; i < 16; i = i + 1) begin: logic_unit_row
            ...
            //row 0: left i+2, center i+1, right i;
                ...
                always @(*) begin
                    num_neighbor[i*16+j] = neighbor[i*16+j][7]+neighbor[i*16+j][6]+neighbor[i*16+j][5]+neighbor[i*16+j][4]+neighbor[i*16+j][3]+neighbor[i*16+j][2]+neighbor[i*16+j][1]+neighbor[i*16+j][0];
                end
