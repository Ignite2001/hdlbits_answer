    ...
    generate
        ...
        for (i = 0; i < 16; i = i + 1) begin: logic_unit_row
            ...
            //row 0: left i+2, center i+1, right i;
                ...
                always @(*) begin
                    neighbor = {regfile[i_mod16_upper*16+(15-j_mod16_left)],    regfile[i_mod16_upper*16+(15-j)], regfile[i_mod16_upper*16+(15-j_mod16_right)]
                                regfile[i*16+(15-j_mod16_left)],                regfile[i*16+(15-j)], };  
                end
            end
        end
    endgenerate
